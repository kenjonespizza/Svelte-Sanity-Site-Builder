...
<div>
  ...
  <div class="mt-3">
    <a href={`blog/${post.pageInfo.slug.current}`} rel=prefetch  class="text-base leading-6 underline font-semibold text-indigo-600 hover:text-indigo-500 transition ease-in-out duration-150">
      Read post
    </a>
  </div>
</div>