          ...
          <blockquote class="flex flex-col justify-center h-full py-12 px-6 md:py-16">
              ...
              <footer class="mt-8">
                <div class="flex">
                    ...
                    <img class="rounded-full border-2 border-textOnPrimary h-10 w-10 object-cover object-center" src={testimonial.authorImage ? urlFor(testimonial.authorImage).quality(80).width(1400) : '/images/userImageNotFound.png'} alt={testimonial.authorName}>
